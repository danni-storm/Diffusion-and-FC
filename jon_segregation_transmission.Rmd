...
modelFigures <- reactive({
    ...
    g <- ggplot(modelRun(), aes(x = time)) +
        geom_line(aes(y = 1e5 * R1), colour = "blue") +
        geom_line(aes(y = 1e5 * R2), colour = "red") +
        xlab("Day") +
...
##### Calculate Risk for Both Groups #################################
...
##### Combine Incidence Calculated Below #################################
